...
and inspires a decent research study of the science of deep specifications~\cite{deepspec}.
...
and \emph{artificial intelligence} experts to fill in this enormous gap between low-level system programming and high-level specification reasoning
by providing
...
to express the full functionality. 
\begin{comment}
...
When focusing on a single verification task between two layers,
 the gap between the implementation and its deep specification, as well as the gap between the two adjacent deep specifications
...
artificial intelligence. We have successfully synthesize
